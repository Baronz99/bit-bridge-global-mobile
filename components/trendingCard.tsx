...
const TrendingMovieCard = ({ movie: { movie_id, poster_url, title }, index }: any) => {
  return (
    <Link href={`/movies/${movie_id}`} asChild>
      <TouchableOpacity className="w-32 relative bg-blue- pl-5">
        <Image
          source={{
            uri: poster_url,
          }}
          ...
          resizeMode="cover"
        />
        <View className="absolute bottom-9 bg-red- -left-3.5  px-2 py-1 rounded-full">
          <MaskedView
