...
const ConfirmEmail = () => {
  ...
  return (
    <View className='flex-1 bg-primary flex justify-center items-center px-4'>
      <View>
        <Text className='text-white my-4 text-center font-semibold text-xl'>An Email has been sent to {email ?? "you"}</Text>
      </View>
        ...
        <View className='items-center justify-center'>
          <View>
              ...
              <TouchableOpacity className='py-3 px-4  flex-row items-center flex justify-center mt-10  bg-app-primary rounded-lg'
                onPress={handleLogin}
                >
