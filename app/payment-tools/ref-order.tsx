...
import { getRefOrder } from '@/api/paymentProcessors'
    ...
    <View className="flex-1 bg-primary px-4">
      <KeyboardAvoidWrapper>
        <View className="flex-1 pt-10">
          <Text className="text-white text-2xl mb-2">Reference Order Lookup</Text>
          <Text className="text-gray-300 mb-6">Fetch the reference order details.</Text>
          ...
          <TouchableOpacity onPress={handleLookup} className="bg-theme-primary py-6 rounded-xl">
            <Text className="text-alt font-medium text-center">Lookup</Text>
          </TouchableOpacity>
