...
const index = () => {
  ...
  const tier2Complete = typeof checks?.tier2_ready === 'boolean' ? checks.tier2_ready : tier2ByLevel || tier2Missing.length === 0
  const tier3Complete = typeof checks?.tier3_ready === 'boolean' ? checks.tier3_ready : kycLevel === 'tier_3' || kycLevel === 'tier_4' || kycLevel === 'tier3' || kycLevel === 'tier4'
  const tier4Complete = typeof checks?.tier4_ready === 'boolean' ? checks.tier4_ready : kycLevel === 'tier_4' || kycLevel === 'tier4'
