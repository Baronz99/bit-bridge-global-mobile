...
const setupStageCopy = ({ isLive, canActivate, businessStatus, missingProfileFields, missingSignatoryRequirements, readiness, journey }: any) => {
  ...
  if (!readiness?.documents_ready || !readiness?.ready_for_kyb_submission) return { stage: 'Documents required', nextTitle: 'Upload verification documents', nextBody: 'Upload the required business documents before submitting for provider review.', tone: 'amber' }
