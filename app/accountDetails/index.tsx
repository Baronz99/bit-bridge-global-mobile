    ...
    <View className="flex-1">
        <View className="bg-purple-700 my-6 flex-row justify-between rounded-2xl h-28  px-6">
            ...
            <View>
                    ...
                    <Text className="text-white text-left text-4xl my-2  font-bold">{moneyFormat(userProfileData?.wallet?.balance)}</Text>
            </View>
      ...
      <View className="flex gap-1 my-4">
        ...
        <Text className="text-gray-200">Bit Bridge Global - {userProfileData?.account?.account_name}</Text>
      </View>
      <View className="flex gap-1 my-4">
      ...
      <View className="flex gap-2">
        ...
        <Text className={` ${userProfileData?.active ? "text-green-600" : "text-red-600" } font-medium`}>{userProfileData.active ? "Active" : "In-Active"}</Text>
      </View>
    </View>
