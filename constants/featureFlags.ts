...
export const FEATURE_CIRCLES = flagEnabled(process.env.EXPO_PUBLIC_FEATURE_CIRCLES ?? '0')
export const FEATURE_TIMELINE = flagEnabled(process.env.EXPO_PUBLIC_FEATURE_TIMELINE ?? '0')
export const FEATURE_NEW_DASHBOARD = flagEnabled(process.env.EXPO_PUBLIC_FEATURE_NEW_DASHBOARD ?? '0')
export const FEATURE_ONBOARDING = flagEnabled(process.env.EXPO_PUBLIC_FEATURE_ONBOARDING ?? '0')
export const FEATURE_TRANSACTION_PIN = flagEnabled(process.env.EXPO_PUBLIC_FEATURE_TRANSACTION_PIN ?? '0')
export const FEATURE_ORDERS = flagEnabled(process.env.EXPO_PUBLIC_FEATURE_ORDERS ?? '0')
export const FEATURE_DISPUTES = flagEnabled(process.env.EXPO_PUBLIC_FEATURE_DISPUTES ?? '0')
export const FEATURE_REWARDS = flagEnabled(process.env.EXPO_PUBLIC_FEATURE_REWARDS ?? '0')
